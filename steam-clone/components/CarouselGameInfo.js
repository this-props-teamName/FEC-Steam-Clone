  ...
  return (
    <div className='w-[324px] ml-[0px] float-right'>
      <div className='p-[0px]'>
        ...
        {/* need to use database for text below */}
        ...
        <div className='flex leading-[16px] text-[#c6d4df] text-[12px]'>
          ...
          <div className='truncate leading-[16px]'>
            <a className='text-[#67c1f5]' href='https://store.steampowered.com/developer/WBGames?snr=1_5_9__2000'>Avalanche Software</a>
          </div>
        </div>
        <div className='flex leading-[16px]'>
          <div className='truncate text-[#556772] uppercase text-[10px] pr-[10px] min-w-[94px]'>Publisher:</div>
          <div className='truncate leading-[16px] '>
            <a className='text-[#67c1f5]' href='https://store.steampowered.com/publisher/WBGames?snr=1_5_9__2000'>Warner Bros. Games</a>
          </div>
        </div>
      </div>
      <div>
        <div className='mt-[10px] text-[11px]'>
          <div className='leading-[19px] text-[12px] text-[#556772]'>Popular user-defined tags for this product:</div>
          <div className='truncate h-[22px]'>
